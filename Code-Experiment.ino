...
void loop() {
  ...
  //Vehicle At Point A
  if (Distance <= 25 && Distance > 24.5 && flag1 == 0 && flag2 == 0) {
    time1 = millis();
    distance1 = Distance;
    flag1 = 1;
  ...
  //Vehicle At Point B
  if (Distance <= 15 && Distance > 14.5 && flag1 == 1 && flag2 == 0) {
    time2 = millis();
    distance2 = Distance;
    flag2 = 1;
  ...
  //Brightness Set To 800 And Object Detection At 40 Cm
  if (brightness < 800 && Distance <= 40) {
